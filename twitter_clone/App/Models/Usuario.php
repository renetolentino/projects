...
class Usuario extends Model {
	...
	public function seguirUsuario($id_usuario_seguindo) {
		$query = 'insert into seguidores(id_usuario, id_usuario_seguindo) values (:id_usuario, :id_usuario_seguindo)';
	...
	public function getTotalSeguidores() {
		$query = "select count(*) as total_seguidores from seguidores where id_usuario_seguindo = :id_usuario";
		$stmt = $this->db->prepare($query);
		$stmt->bindValue(':id_usuario', $this->__get('id'));
		$stmt->execute();
