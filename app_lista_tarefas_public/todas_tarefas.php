	...
	<head>
		...
		<script>
			...
			function marcarRealizada(id) {
				location.href = 'index.php?acao=marcarRealizada&id=' + id + '&remetente=index'
			}
...
<?php if($tarefa->status == 'pendente') { ?>
												...
												<i class="fas fa-check-square fa-lg text-success" onclick="marcarRealizada(<?= $tarefa->id?>)"></i> <?php } ?> 
											</div>
										</div>
								<?php } ?>
